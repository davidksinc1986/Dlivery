            ...
            {selectedRole === "driver" && (
              <>
                ...
                <div className="form-group">
                  ...
                  <div>
                    <input type="checkbox" value="moto" checked={selectedVehicleTypes.includes("moto")} onChange={handleVehicleTypeChange} /> Moto
                    <input type="checkbox" value="camion_liviano" checked={selectedVehicleTypes.includes("camion_liviano")} onChange={handleVehicleTypeChange} style={{ marginLeft: 12 }} /> Camión liviano
                    <input type="checkbox" value="camion_pesado" checked={selectedVehicleTypes.includes("camion_pesado")} onChange={handleVehicleTypeChange} style={{ marginLeft: 12 }} /> Camión pesado
                  </div>
                </div>
